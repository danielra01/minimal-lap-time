...
\begin{document}
    ...
    \begin{frame}{Extension: Static Obstacle Avoidance}
        \vspace{0.3cm}
        \textbf{Effective obstacle radii}
        \[
        ...
        {\scriptsize
        $l_i$, $w_i$ -- obstacle length and width, $L$, $b$ -- vehicle wheelbase and width, 
        $d_{\mathrm{safe}}$ -- safety margin.
        }
        ...
        \begin{itemize}
            \item Obstacles are represented by elliptical safety regions in Frenet coordinates.
            \item Constraints are evaluated at shooting nodes and interval midpoints.
        \end{itemize}
    \end{frame}

    \begin{frame}{Optimized Trajectory with Obstacles}
        \centering
        \includegraphics[
        width=0.90\textwidth,
        height=0.72\textheight,
