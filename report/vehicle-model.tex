...
\begin{align*}
    ...
    \dot{v} &= a.
\end{align*}
The constants $L$ and $a$ denote the wheelbase of the car, i.e. the distance between the front and rear wheel, and the acceleration of the car respectively. For more details on this model, see \cite{Rajamani2012}.
